...
`;
    ...
    // Must be `fixed` (not `relative`) so the layer fills the viewport; `relative` breaks `fixed` from className and collapses height.
    ...
    if (import.meta.env.DEV) {
      ...
      console.log('[LiquidEther] WebGL started', {
        hasCanvas: !!canvas,
